...
function encode(primary: number, accent: number): string {
    const message = `[Zzz#${primary.toString(16).padStart(6, "0")}|#${accent.toString(16).padStart(6, "0")}]`;
    const padding = "";
...
function decode(bio: string): Array<number> | null {
    ...
    /\u{e005b}\u{e005a}\u{e007a}\u{e007a}\u{e0023}([\u{e0061}-\u{e0066}\u{e0041}-\u{e0046}\u{e0030}-\u{e0039}]{6})\u{e007c}\u{e0023}([\u{e0061}-\u{e0066}\u{e0041}-\u{e0046}\u{e0030}-\u{e0039}]{6})\u{e005d}/u,
    );
    if (colorString != null) {
        ...
        const colors = parts.map(x => parseInt(x.replace("Zzz#", "0x").replace("#", "0x"), 16));
